  ...
  const loginMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      if (error?.message?.includes("Multiple users found")) {
        errorMessage = "Múltiplos usuários encontrados. Use o formato: usuário@domínio";
      }
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="usuário ou usuário@domínio"
                  data-testid="input-login-username"
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Use "usuário@domínio" se houver múltiplos usuários com mesmo nome
                </p>
              </div>
