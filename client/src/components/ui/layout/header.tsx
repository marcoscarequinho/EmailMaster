            ...
            {['admin', 'super_admin'].includes(user.role) && (
              <div className="flex items-center space-x-2">
                <Link href="/admin/users" className="inline-block">
                  <span className="flex items-center space-x-2 px-3 py-2 text-sm rounded-md hover:bg-muted transition-colors" data-testid="link-admin-users">
                    <Users className="h-4 w-4" />
                    <span>Usuários</span>
                  </span>
                </Link>
                {user.role === 'super_admin' && (
                  <Link href="/admin/domains" className="inline-block">
                    <span className="flex items-center space-x-2 px-3 py-2 text-sm rounded-md hover:bg-muted transition-colors" data-testid="link-admin-domains">
